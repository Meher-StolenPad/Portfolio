...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    visibilite: Attribute.Boolean;
    playStoreLink: Attribute.String;
    appStoreLink: Attribute.String;
    steamLink: Attribute.String;
    ReadMeStructure: Attribute.Blocks;
    img1Desc: Attribute.Media;
    img2desc: Attribute.Media;
    img3desc: Attribute.Media;
    videoDesc: Attribute.Media;
    GifDesc: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
